                ...
                {(() => {
                    ...
                    return (
                        <div style={{marginTop: '1rem', display: 'flex', gap: '20px'}}>
                            <div style={{background: '#333', padding: '10px', borderRadius: '5px', flex: 1, textAlign: 'center', borderBottom: '3px solid #64ffda'}}>
                                <div style={{fontSize: '0.8rem'}}>VATA</div>
                                <div style={{fontSize: '1.5rem', fontWeight: 'bold'}}>{scores.vata}</div>
                            </div>
                            <div style={{background: '#333', padding: '10px', borderRadius: '5px', flex: 1, textAlign: 'center', borderBottom: '3px solid #ff6b6b'}}>
                                <div style={{fontSize: '0.8rem'}}>PITTA</div>
                                <div style={{fontSize: '1.5rem', fontWeight: 'bold'}}>{scores.pitta}</div>
                            </div>
                            <div style={{background: '#333', padding: '10px', borderRadius: '5px', flex: 1, textAlign: 'center', borderBottom: '3px solid #facc15'}}>
                                <div style={{fontSize: '0.8rem'}}>KAPHA</div>
                                <div style={{fontSize: '1.5rem', fontWeight: 'bold'}}>{scores.kapha}</div>
                            </div>
                        </div>
                    );
                })()}
